...
public class Poodle {
	/**
	 * Generate a matrix table of how Pattern.split( ) behaves with various
	 * regex patterns and limit values.
	 */
	...
	/**
	 * Output a simple XML document with the results of applying the list of
	 * regex patterns to the input with each of the limit values provided. I
	 * should probably use the JAX APIs to do this, but I want to keep the code
	 * simple.
	 */
