...
public class MappedIO {
	...
	private static Tester[] tests = { new Tester("Stream Write") {
		...
		public void test() throws IOException {
			/* 
			 * Although a mapped write would seem to use a FileOutputStream, all
			 * output in file mapping must use a RandomAccessFile, just as
			 * read/write does in the preceding code.
			 */
		...
		public void test() throws IOException {
			/* Enabling read/wirte mode will be extremely slow */
